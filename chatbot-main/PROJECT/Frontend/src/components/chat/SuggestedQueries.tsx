...
const SuggestedQueries: React.FC<SuggestedQueriesProps> = ({ onQueryClick }) => {
  ...
  return (
    <div>
      <p className="text-2xl font-bold text-white mb-2 uppercase">Suggested Queries:</p>
      <div className="flex flex-wrap gap-2">
        {queries.map((query, index) => (
          <Button
            ...
            variant="outline"
            size="sm"
            className="bg-align-secondary border-align-secondary hover:bg-align-accent/20 text-align-foreground focus:outline focus:outline-2 focus:outline-blue-500"
