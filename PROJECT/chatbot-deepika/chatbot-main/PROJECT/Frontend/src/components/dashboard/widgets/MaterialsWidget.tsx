...
const materials: Material[] = [
  ...
  { id: 5, title: 'Lecture Slides Week 6', type: 'pdf', size: '3.2 MB', course: 'Math 101' },
  { id: 6, title: 'Assignment 3', type: 'doc', size: '0.9 MB', course: 'History 202' },
  { id: 7, title: 'Tutorial Video Part 2', type: 'video', size: '50 MB', course: 'CS 310' },
  { id: 8, title: 'Experiment Results', type: 'image', size: '7.5 MB', course: 'Physics 104' },
  { id: 9, title: 'Final Exam Notes', type: 'pdf', size: '4.1 MB', course: 'Math 101' },
  { id: 10, title: 'Research Paper Example', type: 'doc', size: '1.5 MB', course: 'History 202' },
];
  ...
  return (
    <div className="dashboard-card">
      ...
      <div className="space-y-2">
        {(showAll ? materials : materials.slice(0, 3)).map((material) => (
          <div
            key={material.id}
      ...
      <Button
        ...
        onClick={() => setShowAll(!showAll)} // Toggle between limited and full list
      >
        {showAll ? 'Show Less' : 'Browse All Materials'}
      </Button>
    </div>
  );
};
